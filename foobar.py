...
class DitSeries:
    ...
    def __init__(self, name: str, data: t.Dict[int, t.Any]):
        ...
        self.name = name
        self.data = data[int,t.Any]

    def __mul__(self, arg0: int) -> "DitSeries":
...
class DitDataFrame:
    """ """
    def __init__(self, length : int, series_map : t.Dict[int, t.Any], d: t.Dict[str, t.List[t.Any]]):
